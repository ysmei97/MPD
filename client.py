...
class Client(Cmd):
    ...
    def do_get(self, args):
        ...
        # Switch between byte-shuffling and packet-splitting for get command

        handler = dialects.ByteShuffling(self.client_socket, Hash = self.Hash)
        cached_pkts = handler.do_get(args, cached_pkts)
        '''
